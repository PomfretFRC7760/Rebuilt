...
public class FuelLocator {
    ...
    public FuelLocator(RobotContainer r) {
        this.r = r;

    }

    public Pose2d locateFuel() {
        ...
        Pose2d fuelPose = new Pose2d(targetX, targetY, new Rotation2d(Math.toRadians(r.driveSubsystem.getGyroAngle() + (-tx))));
        return fuelPose;
    }
